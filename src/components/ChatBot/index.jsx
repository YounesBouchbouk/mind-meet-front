...
const Index =  () => {
  const [messages, setMessages] = useState([
    {
      message: "Hello, I'm You're degital psychiatre ! say 'let's start the dialog'!",
      sentTime: "just now",
      sender: "ChatGPT"
    },
  ...
  async function processMessageToChatGPT(chatMessages) { // messages is an array of messages
    ...
    await fetch("https://api.openai.com/v1/chat/completions", 
    {
      method: "POST",
      headers: {
        "Authorization": "Bearer " + process.env.NEXT_PUBLIC_APIKEY || process.env.API_KEY,
  ...
  return (
    <div className="App w-full  relative h-[700px]">
        <MainContainer>
          <ChatContainer>       
            <MessageList 
